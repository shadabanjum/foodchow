				...
				public function theme_setup_wizard_content($content){
					if($this->is_possible_upgrade()){
						array_unshift_assoc($content,'upgrade',array(
							'title' => __( 'Upgrade', 'foodchow' ),
							'description' => __( 'Upgrade Content and Settings', 'foodchow' ),
							'pending' => __( 'Pending.', 'foodchow' ),
							'installing' => __( 'Installing Updates.', 'foodchow' ),
							'success' => __( 'Success.', 'foodchow' ),
